...
import type { CityLocationView, CityViewModel, PublicScenario, PublicState, VisualEvent } from './types';
...
class CivicCityScene extends Phaser.Scene {
  ...
  private drawWorld() {
    ...
    graphics.fillStyle(0x57916b, 0.2).fillCircle(105, 505, 125).fillCircle(910, 75, 105);
